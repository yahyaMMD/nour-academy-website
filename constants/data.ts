...
const services = [
	{
		title: "Take your business to the next level with Votex agency. Custom software has the power to transform your business, automating internal processes and supporting key operations. From modern customer-facing platforms to tailored digital solutions",
		icon: "/loties/growth.json",
	},
	{
		title: "Achieve full control over your business processes with software built to give you a competitive edge. By using the latest technologies, Votex develops solutions that streamline operations, improve workflows, and maximize efficiency",
		icon: "/loties/moneyflow.json",
	},
	{
		title: "Our expert team recommends the best strategy to achieve your goals. Whether enhancing productivity or driving innovation, Votex delivers customized solutions. We combine expertise and technology to empower your business with impactful results",
		icon: "/loties/strategy.json",
	},
];
