...
const testimonials = [
  ...
  {
    id: 2,
    comment: "أكثر شيء أعجبني أن المنصة تجعل الطالب يشعر أن التقدم ممكن. الشرح مباشر، والتنظيم ممتاز، والتسجيل سهل جدا.",
    author: "وليد ر.",
    role: "طالب متوسط",
    location: "البليدة",
    rating: 5,
  ...
  {
    id: 3,
    comment: "كولية أمر، أحببت هذا التوازن بين الجدية والقرب من الطالب. المنصة تعطي انطباعا محترما، وفي نفس الوقت تشجع الطالب ولا ترهبه.",
    author: "أمينة ك.",
    role: "ولية أمر",
    location: "وهران",
    rating: 5,
