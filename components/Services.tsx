...
const pillars = [
  {
    ...
    description:
      "نعرف أن الطالب لا يحتاج فقط إلى درس جديد، بل إلى طريقة تشرح له الفكرة من جذورها وتعيد بناء ثقته بنفسه.",
    color: "bg-[var(--brand-primary-soft)]",
  },
  {
    title: "نحوّل الضغط إلى دافع",
    description:
      "بدل الشعور بالتشتت أو الخوف من التراجع، نصنع بيئة تشجع على المحاولة، وطرح الأسئلة، والتقدم خطوة بعد خطوة.",
    color: "bg-[var(--brand-accent-soft)]",
  },
  {
    title: "النتيجة تبدأ من التجربة",
    description:
      "كل تفصيل في المنصة صُمم ليمنح الطالب شعورًا بالوضوح والجدية والانتماء، لأن الأداء القوي يبدأ من إحساس داخلي قوي.",
      ...
      <Container>
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          >
            ...
            <h2 className="mb-5 font-[var(--font-brand-heading)] text-3xl font-extrabold leading-[1.28] text-[var(--brand-ink)] md:text-4xl md:leading-[1.3]">
              منصة تؤمن أن الطالب حين يفهم جيدًا
              <span className="text-[var(--brand-accent)]"> يقدر أن يتفوق بثبات.</span>
            </h2>
            <p className="mb-6 text-lg leading-8 text-[var(--brand-muted)]">
              في منصة النور لا نقدم محتوى تعليميًا باردًا أو مكررًا. نحن نبني تجربة كاملة تجعل الطالب أكثر تركيزًا، وأكثر راحة، وأكثر استعدادًا لبذل جهده لأنه يرى الطريق أمامه بوضوح.
            </p>
